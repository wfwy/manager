...
String sql = "select * FROM score,item where score.itme=item.item and item.type='"+type+"'" ;
...
while(i<intPageSize &&!rs.isAfterLast()){
		...
		out.print("<td><a href='record?id="+rs.getInt("id")+"' onclick='javascript:return del();' class='layui-btn'><i class='layui-icon'></i>删除</a></td>");
		out.print("</tr>");
		rs.next();
        i++;
        }
