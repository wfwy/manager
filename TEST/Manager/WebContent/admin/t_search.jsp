...
<script src="../js/addteacher.js" charset="utf-8"></script>
...
String sql = "SELECT * FROM teacher where college='"+college+"'";
...
while(i<intPageSize &&!rs.isAfterLast()){
		...
		out.print("<td><a href='teachermanagement_del?t_num="+rs.getString("t_num")+"' onclick='javascript:return del();' class='layui-btn'><i class='layui-icon'></i>删除</a></td>");
		out.print("<td><a href='update.jsp?t_num="+rs.getString("t_num")+"' class='layui-btn'><i class='layui-icon'></i>修改</a></td>");
		out.print("</tr>");
		rs.next();
        i++;
        }
